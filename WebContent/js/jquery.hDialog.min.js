	...
	methods = {init : function(options) {
			return this.each(function() {
				...
				$this.on(opt.triggerEvent, function() {
					if (opt.resetForm) {
						...
						$obj.find("input[type=radio],input[type=checkbox]")
								.removeAttr("checked")
					}
					if (opt.escHide) {
		...
		add : function(o, $this) {
			...
			if (o.closeHide != false) {
				$obj.stop()
						.append(
								'<a id="HCloseBtn" title="关闭" style="width:24px;height:24px;line-height:18px;display:inline-block;cursor:pointer;background-color:'
										+ closeBg
		...
		close : function(o, urls) {
			...
			function _effect() {
				...
				$(this).removeAttr("class").removeAttr("style").addClass(
						"animated").hide();
				if (urls != undefined) {
					setTimeout(function() {
		...
		if (methods[method]) {
			...
			if (typeof method === "object" || !method) {
				...
				$.error("Error! Method" + method
						+ "does not exist on jQuery.hDialog！")
			}
		}
	};
	$.extend({
				showLoading : function(t, w, h) {
					...
					$body.stop().append(
									'<div id="HLoading" style="width:'
											...
											+ "px;line-height:"
											+ h
											+ "px;background:rgba(0,0,0,0.6);color:#fff;text-align:center;position:fixed;top:50%;left:50%;margin:"
											+ margin + ';">' + t + "</div>")
				},
				...
				tooltip : function(t1, t2, t3) {
					...
					var tip = '<div class="HTooltip shake animated" style="width:280px;padding:10px;text-align:center;background-color:#D84C31;color:#fff;position:fixed;top:10px;left:50%;z-index:100001;margin-left:-150px;box-shadow:1px 1px 5px #333;-webkit-box-shadow:1px 1px 5px #333;">'
							+ t1 + "</div>";
					if (t3) {
						tip = '<div class="HTooltip fadeIn animated" style="width:280px;padding:10px;text-align:center;background-color:#5cb85c;color:#fff;position:fixed;top:10px;left:50%;z-index:100001;margin-left:-150px;box-shadow:1px 1px 5px #333;-webkit-box-shadow:1px 1px 5px #333;">'
								+ t1 + "</div>"
					}
