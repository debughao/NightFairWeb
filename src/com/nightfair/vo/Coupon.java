...
public class Coupon {
	...
	public Coupon(int id, int seller_id, int original_price, int current_price, String description, String public_time,
			String update_time, int seller_counts) {
		super();
		this.id = id;
		this.seller_id = seller_id;
		this.original_price = original_price;
	 ...
	 * @param state
	 */
	public Coupon(int seller_id, int original_price, int current_price, String description, String public_time,
			String update_time, int seller_counts) {
		super();
		this.seller_id = seller_id;
		this.original_price = original_price;
	...
	public Coupon(int id, int seller_id, int original_price, int current_price, String description, int seller_counts) {
		super();
		this.id = id;
		this.seller_id = seller_id;
		this.original_price = original_price;
	...
	public Coupon(int id, int seller_id, int original_price, int current_price, String description, String public_time,
			String update_time, int seller_counts, int isguess, int isrecommend) {
		super();
		this.id = id;
		this.seller_id = seller_id;
		this.original_price = original_price;
	...
	public String toString() {
		return "Coupon [id=" + id + ", seller_id=" + seller_id + ", original_price=" + original_price
				...
				+ ", update_time=" + update_time + ", seller_counts=" + seller_counts + ", isguess=" + isguess
